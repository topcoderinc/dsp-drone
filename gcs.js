...
let mavDataStreams = {
    MAV_DATA_STREAM_ALL: {
        id: 0,
        streams: ['IMU_RAW', 'GPS_RAW', 'GPS_STATUS', 'CONTROL_STATUS', 'AUX_STATUS', 'RC_CHANNELS_SCALED', 'RC_CHANNELS_RAW', 'SERVO_OUTPUT_RAW', 'ATTITUDE_CONTROLLER_OUTPUT', 'POSITION_CONTROLLER_OUTPUT', 'NAV_CONTROLLER_OUTPUT', 'LOCAL_POSITION_NED', 'GLOBAL_POSITION', 'GLOBAL_POSITION_INT']
    },
    MAV_DATA_STREAM_RAW_SENSORS: {
        id: 1,
        streams: ['IMU_RAW', 'GPS_RAW', 'GPS_STATUS']
    },
